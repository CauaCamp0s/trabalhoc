...
void imprimir_menu()
{
    ...
    printf("5 - Listar alunos reprovados por media \n");
...
void alterarAluno()
{
    ...
    printf("Digite as tres novas notas do aluno \n");
    printf("Nota 1: ");
...
void listarAlunos()
{
    ...
    printf("Matricula  |  Nota 1  |  Nota 2  |  Nota 3  |  Faltas \n");
    for (int i = 0; i < numAlunos; i++)
    {
...
void listarAlunosAprovados()
{
    ...
    for (int i = 0; i < numAlunos; i++)
    {
        ...
        {
            printf("Matricula: %d, Nota media: %.2f, Faltas: %d \n",
...
void listarAlunosReprovadosMedia()
{
    ...
    for (int i = 0; i < numAlunos; i++)
    {
        ...
        if (media < 6)
        {
            printf("Matricula: %d, Nota media: %.2f \n", alunos[i].matricula, media);
        }
    }
}
